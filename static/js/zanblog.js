...
var zan = {
	...
	init: function() {
		...
		//jQuery('body').scrollspy({ target: '#myScrollspy' , offset: 70});
	},
	...
	goTop: function() {
		jQuery(window).scroll(function() {
			...
			jQuery("#zan-gotop").fadeIn(500);
			} else{ 
			jQuery("#zan-gotop").fadeOut(500);
			}
		});
	...
	archivesNum: function() {
 	...
 	// 延时加载图片功能
	lazyload: function() {
		jQuery("img.lazy").lazyload({ effect : "fadeIn" ,threshold : 200,skip_invisible : false});
	},
	...
	ajaxCommentsReply :function() {
		...
		var $commentform = $('#commentform'),
		    txt1 = '<div id="loading" class="alert alert-info" role="alert"><i class="fa fa-spinner fa-spin"></i> 正在提交, 请稍候...</div>',
		    txt2 = '<div id="error" class="alert alert-danger" role="alert">#</div>',
				cancel_edit = '取消编辑',
				num = 1,
